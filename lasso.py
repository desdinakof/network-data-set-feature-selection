...
#df = pd.read_csv("C:/Users/desdina.kof/Desktop/calismalarim/saga/Thursday-WorkingHours-Morning-WebAttacks.csv", usecols=lst)
df = pd.read_csv("C:/Users/desdina.kof/Desktop/calismalarim/saga/GeneratedLabelledFlows/TrafficLabelling/Friday-WorkingHours-Afternoon-DDos
#df = pd.read_csv("C:/Users/desdina.kof/Desktop/calismalarim/saga/GeneratedLabelledFlows/TrafficLabelling/Thursday-WebAttacks_2.csv", usecols=lst, encoding='cp1252')
df[' Label'].unique()
